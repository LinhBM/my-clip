...
function LoginLinkAccount() {
  ...
  return (
    <div className="absolute top-0 right-0 bottom-0 left-0 w-[480px] h-[660px] m-auto bg-[#000000] border-[1px] border-solid border-[#141414] rounded-2xl flex flex-col items-center">
